...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/13 06:34:21 by hkocan            #+#    #+#             */
/*   Updated: 2024/03/13 06:34:22 by hkocan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	put_digit(long long int number, char *base, int bsize)
{
	int	counter;
	int	tmp;
...
static int	put_digit_pointer(void *point, char *base, int bsize)
{
	int					counter;
	int					tmp;
